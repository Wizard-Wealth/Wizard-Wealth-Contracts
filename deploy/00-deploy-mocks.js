...
const ETH_USD_INITIAL_PRICE = ethers.parseUnits("1000", 8); // 1 ETH = $1,000
const BTC_USD_INITIAL_PRICE = ethers.parseUnits("2000", 8); // 1 BTC = $2,000
const DAI_USD_INITIAL_PRICE = ethers.parseUnits("1", 8); // 1 DAI = $1
